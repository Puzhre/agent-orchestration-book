...
### 2024年新原则
5. **状态持久化**：技能跨会话保持状态（96%成功率）
6. **版本控制**：独立版本控制，避免LLM锁定（92%耦合降低）
7. **专业化分工**：专业化技能比通用技能可靠3.8倍
8. **混合方法**：75% Skill + 25% MCP工具实现96%总体成功率
9. **自进化能力**：AI驱动的技能优化减少34%维护开销
