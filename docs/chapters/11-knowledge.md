...
## 7.1 Why Knowledge Accumulation Matters
...
## 7.2 Paradigm One: Natural Language Experience Documents (Tmux-Orchestrator)
...
## 7.3 Paradigm Two: Structured Knowledge Base (Overstory)
...
## 7.4 Paradigm Three: Semantic Memory (agency-agents-zh)
...
## 7.5 Comparison of the Three Paradigms
...
## 7.6 Overlay Injection: The Bridge from Knowledge to Agent
...
## 7.8 Design Principles for Knowledge Accumulation
